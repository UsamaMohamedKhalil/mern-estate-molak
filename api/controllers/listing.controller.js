...
export const updateListing = async (req, res, next) => {
 ...
 // Controller function to get a listing by ID
...
// Controller function to get multiple listings based on filters
...
// Controller function to get listings by city
export const getListingsByCity = async (req, res, next) => {
   try {
      ...
      next(errorHandeler(500, 'Server error while fetching listings'));
   }
};
